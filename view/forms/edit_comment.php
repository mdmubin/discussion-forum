...
<div class="ui grid stackable container">
    <div class="row">
        <div class="eleven wide column">
            ...
            <div class="ui row">
                <div class="column">
                    <form class="ui form" method="POST" action="../../controllers/updatecomment.php">
                        <div class="field">
                            <label>New Comment</label>
                            <textarea type="text" name="content" placeholder="Update Comment"></textarea>
                        </div>
                        <?php
                            $uname = $_GET['uname'];
                            $comid = $_GET['comid'];
                            ...
                            echo "<input type='text' name='commentid' value=$commentid hidden>";
                    ...
                    <?php
                        echo "<a href='../../controllers/deletecomment.php?commentid=$commentid&uname=$uname&comid=$comid&postid=$postid'><button class='ui button red large right floated'>Delete</button></a>"
                    ?>
                </div>
            </div>
        </div>
