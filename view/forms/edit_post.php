...
<div class="ui grid stackable container">
    <div class="row">
        <div class="eleven wide column">
            ...
            <div class="ui row">
                <div class="column">
                    <form class="ui form" method="POST" action="../../controllers/updatepost.php">
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <textarea type="text" name="content" placeholder="Updated Post"></textarea>
                        </div>
                        <?php
                            $uname = $_GET['uname'];
                            $comid = $_GET['comid'];
                    ...
                    <?php
                        echo "<a href='../../controllers/deletepost.php?uname=$uname&comid=$comid&postid=$postid'><button class='ui button red large right floated'>Delete</button></a>"
                    ?>
                </div>
            </div>
        </div>
